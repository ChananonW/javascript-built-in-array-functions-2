...
const memberName = totalMembers.map(bill => bill.member.name);
const delName = new Set(memberName);
const memberCount = delName.size;
console.log(`Unique Members Count: ${memberCount}`)